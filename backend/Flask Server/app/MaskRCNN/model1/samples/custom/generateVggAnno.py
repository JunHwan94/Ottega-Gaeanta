...
ROOT_DIR = os.path.abspath("./MaskRCNN/model1/")
print(ROOT_DIR)
...
from samples.custom import coco
...
def main(file_name):
    ...
    filenameWithoutJPG = os.path.splitext(file_name)[0]
    ...
    try:
        ...
        for i in range(masked.shape[2]):
            ...
            image = cv2.imread(ROOT_DIR+"/images/" + file_name)
            ...
            f = file_name.split(".")[0]
            # filename = "../../images/" + class_names[mask_id[k]] + "_%d.jpg" % k
            filename = ROOT_DIR+"/images/" + filenameWithoutJPG + "_" + class_names[mask_id[k]] + "_%d.jpg" % k
            
            # class_names[mask_id[k]]
